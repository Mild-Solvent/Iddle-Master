...
namespace IdleMaster
{
    ...
    internal static class SettingSpec
    {
        ...
        public static readonly string[][] Flags = new string[][]
        {
            ...
            new string[] { "TrimWorkingSets",      "Auto-trim after every boost - costs a stutter when you go back to the app (Trim RAM now works either way)" },
            new string[] { "ClearStandbyList",     "Purge the standby (cached) list - standby is already free memory, this only drops the cache" },
        ...
        public static readonly string[][] Numbers = new string[][]
        {
            ...
            new string[] { "SentryTrimMinutes",    "Re-trim RAM every (minutes, needs auto-trim on)", "1", "1440", "10" },
            ...
            new string[] { "TrimWhenFreeBelowMb",  "Emergency trim when free RAM drops below (MB, 0 = off) - runs even with auto-trim off", "0", "99999", "0" },
